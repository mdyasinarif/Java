...
public class Pe6_15Tax {
    ...
    public static double computeTax(int status, double taxableIncome) {
        double tax, taxRate, incomeTaxed, incomeUntaxed,
                taxAt15Pecent, taxAt25Pecent, taxAt28Pecent, taxAt33Pecent, taxAt35Pecent;

        tax = taxRate = incomeTaxed = incomeUntaxed = taxAt15Pecent = taxAt25Pecent = taxAt28Pecent = taxAt33Pecent = taxAt35Pecent = 0.0;
